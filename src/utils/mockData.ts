...
export const mockReports: Report[] = [
  {
    ...
    tankName: 'Tank 002B',
    submittedBy: '2',
    submittedByName: 'Keomany Vongxay',
  ...
  },
  {
    ...
    tankName: 'Tank 003C',
    submittedBy: '3',
    submittedByName: 'Somsy Phommakone',
    reportType: 'broken_filter',
    description: 'Primary filtration unit appears damaged. Water flow is reduced significantly.',
    photoUrl: 'https://images.pexels.com/photos/11658940/pexels-photo-11658940.jpeg?_gl=1*gpxb3f*_ga*NzkyOTU3MzI2LjE3NjA2NzQ1Mzg.*_ga_8JE65Q40S6*czE3NjA2NzQ1MzckbzEkZzEkdDE3NjA2NzQ2MDgkajYwJGwwJGgw',
    status: 'pending',
  ...
  },
  {
    ...
    tankName: 'Tank 001A',
    submittedBy: '2',
    submittedByName: 'Kounlasith Phimmasone',
...
export const mockMaintenanceLogs: MaintenanceLog[] = [
  {
    ...
    performedBy: '2',
    performedByName: 'Ammata Phommasith',
  ...
  },
  {
    ...
    performedBy: '2',
    performedByName: 'Khamla Vongphachanh',
  ...
  },
  {
    ...
    performedBy: '2',
    performedByName: 'Somsack Douangphachanh',
